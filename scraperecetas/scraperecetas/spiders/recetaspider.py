...
class RecetaspiderSpider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        start_urls = open('../data/raw/recetas_urls.txt').read().splitlines()
    ...
    def parse(self, response):
        ...
        for url in urls:
            ...
            yield scrapy.Request(url=url, callback=self.parse_details, meta={'categoria': categoria})
    ...
    def parse_details(self, response):
        ...
        """
        yield{'categoria': response.meta['categoria'],
